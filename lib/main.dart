...
void main() {
  // Garantiza que los enlaces de Flutter estén listos para ser utilizados, puesto que se requieren configurar preferencias antes de lanzar la aplicación
  WidgetsFlutterBinding.ensureInitialized();
  // Mostrar la aplicación solo en modo vertical (boca arriba / boca abajo)
